...
#v(35pt)
#block(width: 100%, fill: rgb("F8FAFC"), stroke: 0.5pt + rgb("CBD5E1"), radius: 4pt, inset: 11pt)[
...
#grid(
  columns: (1fr, 1fr),
  gutter: 12pt,
  block(width: 100%, fill: rgb("FFFFFF"), stroke: 0.5pt + rgb("CBD5E1"), radius: 4pt, inset: 9pt)[
...
#v(4pt)
#block(width: 100%, fill: rgb("F8FAFC"), stroke: 0.5pt + rgb("CBD5E1"), radius: 4pt, inset: 9pt)[
...
#v(4pt)
#block(width: 100%, fill: rgb("EFF6FF"), stroke: 0.5pt + rgb("BFDBFE"), radius: 3pt, inset: 7pt)[
...
#block(width: 100%, fill: rgb("FFFFFF"), stroke: 0.5pt + rgb("CBD5E1"), radius: 4pt, inset: 10pt)[
...
#grid(
  ...
  gutter: 8pt,
  block(width: 100%, fill: rgb("FFFFFF"), stroke: 0.5pt + rgb("CBD5E1"), radius: 4pt, inset: 8pt)[
  ...
  block(width: 100%, fill: rgb("F8FAFC"), stroke: 1.5pt + rgb("8B7355"), radius: 4pt, inset: 8pt)[
...
#v(7pt)
#block(width: 100%, fill: rgb("FFF1F2"), stroke: 0.5pt + rgb("FECDD3"), radius: 4pt, inset: 8.5pt)[
...
#v(5pt)
#block(width: 100%, fill: rgb("F8FAFC"), stroke: 0.5pt + rgb("CBD5E1"), radius: 4pt, inset: 8.5pt)[
...
#v(7pt)
#block(width: 100%, fill: rgb("0A1128"), radius: 4pt, inset: 11pt)[
  #grid(
    columns: (2.3fr, 1fr),
    gutter: 10pt,
    [
    ...
    [
      #align(center + horizon)[
        #block(fill: rgb("1E293B"), stroke: 0.5pt + rgb("8B7355"), radius: 3pt, inset: 7pt)[
